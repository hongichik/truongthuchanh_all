...
<body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
    <div class="app-wrapper">
        {{-- Include Header --}}
        @include('master-admin::master-admin.layout.partials.header')

        {{-- Include Sidebar --}}
        @include('master-admin::master-admin.layout.partials.sidebar')
        ...
        {{-- Include Footer --}}
        @include('master-admin::master-admin.layout.partials.footer')
    </div>
