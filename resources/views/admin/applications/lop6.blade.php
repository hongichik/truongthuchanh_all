...
@section('title', 'Quản lý đơn xin nhập học lớp 6')
@section('page_title', 'Quản lý đơn xin nhập học lớp 6')
...
<div class="row mb-4">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2><i class="fas fa-user-graduate"></i> Quản lý đơn xin nhập học lớp 6</h2>
                <p class="text-muted">Danh sách và quản lý tất cả đơn đăng ký vào lớp 6</p>
            </div>
            <div>
...
@push('styles')
<link rel="stylesheet" href="https://cdn.datatables.net/1.13.6/css/dataTables.bootstrap4.min.css?v=1.0">
@endpush
...
$(document).ready(function() {
    $('#applicationsTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{ route("admin.applications.lop6.data") }}',
        columns: [
            {data: 'id', name: 'id'},
