        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">Chỉnh sửa Menu: {{ $menu->name }}</h3>
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                                                <i id="icon-preview" class="{{ old('icon', $menu->icon) ?: 'fas fa-link' }}"></i>
                                            </span>
                                        </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('position') is-invalid @enderror" 
                                        ...
                                        <option value="header" {{ old('position', $menu->position) === 'header' ? 'selected' : '' }}>
                                            Header
                                        </option>
                                        <option value="footer" {{ old('position', $menu->position) === 'footer' ? 'selected' : '' }}>
                                            Footer
                                        </option>
                                        <option value="sidebar" {{ old('position', $menu->position) === 'sidebar' ? 'selected' : '' }}>
                                            Sidebar
                                        </option>
                                    </select>
                                    @error('position')
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="alert alert-info">
                                        <h6><i class="fas fa-info-circle"></i> Menu con:</h6>
                                        <ul class="mb-0">
...
$(document).ready(function() {
    // Tự động tạo slug từ tên menu (chỉ khi slug trống)
    ...
    $('#name').on('input', function() {
        ...
        if ($('#slug').val() === originalSlug && originalSlug === '') {
            $('#slug').val(slug);
        }
    });
